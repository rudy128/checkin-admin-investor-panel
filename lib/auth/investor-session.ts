...
const STORAGE_KEYS = {
  authToken: "investor.auth_token",
  authTokenExpiresAt: "investor.auth_token_expires_at",
  refreshToken: "investor.refresh_token",
  refreshTokenExpiresAt: "investor.refresh_token_expires_at",
} as const
